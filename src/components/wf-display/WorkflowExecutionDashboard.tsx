                ...
                (() => {
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      {currentStep.data.job_type === 'script' && (
                        <div className="mb-6">
                          ...
                          <div className="bg-gray-900 bg-opacity-50 rounded-lg p-4 border-l-4 border-blue-500">
                            <div className="grid grid-cols-1 gap-3 text-sm">
                              <div>
                                <span className="text-gray-400">Execution Environment:</span>
                                <span className="ml-3 text-cyan-400">Docker Container (python:3.11-slim)</span>
                              </div>
                              <div>
                                <span className="text-gray-400">Working Directory:</span>
                                <span className="ml-3 text-cyan-400">/app</span>
                              </div>
                              <div>
                                <span className="text-gray-400">Process ID:</span>
                                <span className="ml-3 text-cyan-400">{Math.floor(Math.random() * 9999) + 1000}</span>
                              </div>
                              <div>
                                <span className="text-gray-400">Memory Usage:</span>
                                <span className="ml-3 text-green-400">{Math.floor(Math.random() * 200) + 50}MB</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      {/* API Call Details */}
                      {currentStep.data.job_type === 'api_call' && (
                        <div className="mb-6">
                          <div className="text-blue-400 font-bold mb-3 flex items-center">
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="bg-gray-900 bg-opacity-50 rounded-lg p-4 border-l-4 border-purple-500">
                            <div className="grid grid-cols-1 gap-3 text-sm">
                              <div>
                                <span className="text-gray-400">Request Method:</span>
                                <span className="ml-3 bg-purple-900 bg-opacity-50 text-purple-300 px-2 py-1 rounded text-xs font-bold">
                                  {['GET', 'POST', 'PUT', 'DELETE'][Math.floor(Math.random() * 4)]}
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-400">Response Time:</span>
                                <span className="ml-3 text-green-400">{Math.floor(Math.random() * 2000) + 100}ms</span>
                              </div>
                              <div>
                                <span className="text-gray-400">Status Code:</span>
                                <span className="ml-3 text-green-400">200 OK</span>
                              </div>
                              <div>
                                <span className="text-gray-400">Content Type:</span>
                                <span className="ml-3 text-cyan-400">application/json</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
{currentStep.data.output.stderr}
                      ...
                      <div className="border-t border-gray-700 pt-6">
                        <div className="text-cyan-400 font-bold mb-4 flex items-center">
                          <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div className="bg-gray-800 bg-opacity-50 rounded-lg p-4 text-center">
                            <div className="text-2xl font-bold text-green-400 mb-1">
                              {currentStep.data.output?.exit_code === 0 ? '✅' : '❌'}
                            </div>
                            <div className="text-gray-400 text-xs">Execution Status</div>
                            <div className={`font-semibold ${currentStep.data.output?.exit_code === 0 ? 'text-green-400' : 'text-red-400'}`}>
                              {currentStep.data.output?.exit_code === 0 ? 'SUCCESS' : 'FAILED'}
                            </div>
                          </div>
                          
                          <div className="bg-gray-800 bg-opacity-50 rounded-lg p-4 text-center">
                            <div className="text-2xl font-bold text-blue-400 mb-1">⚡</div>
                            <div className="text-gray-400 text-xs">Runtime Environment</div>
                            <div className="text-blue-400 font-semibold">
                              {currentStep.data.output?.language || 'Docker'}
                            </div>
                          </div>
                          ...
                          <div className="bg-gray-800 bg-opacity-50 rounded-lg p-4 text-center">
                            ...
                            <div className="text-yellow-400 font-semibold">
                              {currentStep.timestamp ? new Date(currentStep.timestamp).toLocaleTimeString() : 'N/A'}
                            </div>
                          </div>
                        </div>
                      </div>
